...
module pll_sensor_clk (CLKI, CLKOP, CLKOS)/* synthesis NGD_DRC_MASK=1 */;
    ...
    EHXPLLL PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOP_t), .PHASESEL1(scuba_vlo), 
        ...
        .CLKOS3(), .LOCK(LOCK), .INTLOCK(), .REFCLK(REFCLK), .CLKINTFB())
             /* synthesis FREQUENCY_PIN_CLKOS="40.500000" */
             /* synthesis FREQUENCY_PIN_CLKOP="40.500000" */
    ...
    // exemplar begin
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS 40.500000
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOP 40.500000
