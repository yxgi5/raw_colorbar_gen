...
/* Module Version: 5.7 */
/* /opt/lscc/diamond/3.11_x64/ispfpga/bin/lin64/scuba -w -n pll_sensor_clk -lang verilog -synth synplify -arch xo3c00f -type pll -fin 24 -fclkop 40 -fclkop_tol 0.0 -fclkos 40 -fclkos_tol 0.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 225 -trims_r -phase_cntl STATIC -fb_mode 5  */
/* Thu Apr 23 09:46:38 2020 */


`timescale 1 ns / 1 ps
module pll_sensor_clk (CLKI, CLKOP, CLKOS)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
    output wire CLKOS;
    ...
    defparam PLLInst_0.CLKOS_CPHASE = 20 ;
